    ...
    <div className="absolute flex top-0 justify-center w-[100%] items-center h-[100%]">
      <div className="bottom-5 right-5 w-[75%] h-[80%] bg-gray-700/10 backdrop-blur-lg border border-white/10 rounded-2xl shadow-lg shadow-black/30 p-5 flex flex-col justify-between">
        <div className="flex justify-between items-center">
          <p>Kabi Chat <span className="text-gray-400">v1.0</span></p>
            ...
            {data.map((item, index) =>{ 
              ...
              return(
                <div key={index}>
                  ...
                  {isLast && thinking ? <img src={THINK} alt="Thinking..." className="w-[70px] ms-5" /> : <div className="flex gap-3"><img src={SPEAK} alt="Speaking..." className="md:w-[50px] w-[30px] h-[35px] md:h-[55px]" /><p className="bg-gray-500/50 text-gray-200 px-3 py-2 rounded-xl w-[80%]">{item.botText}</p></div>}
                </div>
            )})}
          </div>
