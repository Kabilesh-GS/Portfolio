  ...
  return (
    <div className={Aboutexp.containerMain}>
      ...
      <div className={Aboutexp.container}>
        ...
        <p className={`${Aboutexp.des} ${Aboutexp.marginleftright}`}>Worked as a Frontend Developer intern in Spotknack to create React web application to enhance their rewards platform. We used react packages like ChartJS to improve the user interactivity of the application. The application is integrated with the back end with the help of Axios.</p>
      </div>
    </div>
  )
}
