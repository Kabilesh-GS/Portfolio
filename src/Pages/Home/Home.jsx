...
function Home() {
  ...
  return (
    <div className="text-white font-[Sora]">
      <div className="rounded-2xl mt-8 mx-8 px-15 py-5 bg-white/5 backdrop-blur-md border border-white/10 shadow-lg shadow-black/30 flex flex-col md:flex-row gap-5 md:gap-0 justify-between items-center">
        <div className="">
      ...
      <div className="flex flex-col md:flex-row items-start">
        ...
        <div className="flex flex-col w-[100%] md:w-[65%] justify-center ">
          ...
          <div className="flex mx-8 bg-white/5 backdrop-blur-md border justify-center border-white/10 rounded-2xl shadow-lg shadow-black/30 mt-5 py-5 px-15 md:gap-10 gap-5">
          ...
          <div className="flex cursor-default mx-8 bg-white/5 backdrop-blur-md border justify-center border-white/10 rounded-2xl shadow-lg shadow-black/30 mt-5 py-5 px-15 md:gap-18 gap-5">
