...
function Projects() {
  return (
    <div className={Prostyle.containupper} style={{paddingBottom: '60px'}}>
        ...
        <Projectscontainer contentheading='Simple Day Finder' link='https://kabilesh-gs.github.io/Day-Finder/' content='Just a Simple day finder I did using javascript. It Takes a date as an input and returns with the corresponding day.' videosrc={DayFinder}/>
        <Projectscontainer contentheading='Pokemon Cards' link='https://kabilesh-gs.github.io/Pokemon-Finder/' content='A Pokemon card generator using API to find and generate a card for each pokemon along with their stats like health, speed, attack !' videosrc={Pokemon}/>
