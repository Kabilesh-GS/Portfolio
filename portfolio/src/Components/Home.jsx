  ...
  return (
    <div className={`${Homestyle.maincontainer} ${Homestyle.radius} ${Homestyle.flex} ${Homestyle.margin}`}>
        <div className={`${Homestyle.margin53px} ${Homestyle.margin43px} ${Homestyle.color}`}>
            ...
            <p className={`${Homestyle.questrial} ${Homestyle.margin16px} ${Homestyle.font25px} ${Homestyle.lineheight}`}>I’m currently working as an React<br /> Intern at Spotknack. </p>
        </div>
